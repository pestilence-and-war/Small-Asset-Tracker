...
class CustomFieldForm(FlaskForm):
    name = StringField('Field Name', validators=[DataRequired(), Length(min=2, max=100)])
    type = SelectField('Field Type', choices=[('text', 'Text'), ('number', 'Number'), ('date', 'Date')],
...
class EmailSettingsForm(FlaskForm):
    ...
    mail_username = StringField('Username')
    mail_password = PasswordField('Password')
